"""Original transposition-table variant of the verified reference search.

Bounds require identical reversible-history multisets and halfmove/ply context.
Position-only matches can order moves but never supply context-unsafe bounds.
