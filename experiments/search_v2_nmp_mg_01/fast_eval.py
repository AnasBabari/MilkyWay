    ...
    def _eval_kernel(
        ...
        if w_king_sq >= 0:
            ...
            if ks_c:
                ...
                patt = (
                    ((ubp & np.uint64(0xFEFEFEFEFEFEFEFE)) >> np.uint64(9))
                    | ((ubp & np.uint64(0x7F7F7F7F7F7F7F7F)) >> np.uint64(7))
                )
        ...
        if b_king_sq >= 0:
            ...
            if ks_c:
                ...
                patt = (
                    ((uwp & np.uint64(0xFEFEFEFEFEFEFEFE)) << np.uint64(7))
                    | ((uwp & np.uint64(0x7F7F7F7F7F7F7F7F)) << np.uint64(9))
                )
