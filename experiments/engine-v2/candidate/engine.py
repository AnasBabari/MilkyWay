...
class MilkyWayEngine:
    ...
    def choose_move(self, fen: str, time_left_ms: int) -> str:
        ...
        # usable clock. A fixed depth-four ceiling wastes time in positions
        # with few legal moves, especially pawn endings needing long lines.
        # Critically low clocks retain the shallow emergency search.
