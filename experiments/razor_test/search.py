...
class Searcher:
    ...
    def _negamax(
        ...
        # Razoring: at very low depth, if static eval is far below alpha,
        # just do quiescence instead of full search.
        if (
            not in_check
            and depth <= 2
            ...
            razor_margin = 250 if depth == 1 else 500
            if static + razor_margin < alpha:
                return self._quiescence(board, alpha, beta, ply, 0)
