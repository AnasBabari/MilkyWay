...
class MilkyWayEngine:
    ...
    def choose_move(self, fen: str, time_left_ms: int) -> str:
        ...
        # Single-core CPU root policy move scores for ordering. The value
        # head is intentionally unused: uncertainty time scaling built on it
        # overspent early on noisy disagreements and cost ~100 Elo in the
        # SF6 screen (29.2% vs 41.7% policy-only on identical pairs).
        # See session log §7. Value work resumes only with a better signal.
